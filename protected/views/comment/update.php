...
<div class="max-w-screen-lg mx-auto mt-6 p-6 bg-white text-gray-800 rounded-lg shadow-md border border-gray-300">
    <h1 class="text-2xl font-bold mb-4">Update Comment #<?php echo $model->id; ?></h1>
    ...
    <div class="flex flex-wrap gap-2 mb-4">
        ...
        <?php echo CHtml::link('View Comment', array('view', 'id' => $model->id), array('class' => 'bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition text-sm')); ?>
